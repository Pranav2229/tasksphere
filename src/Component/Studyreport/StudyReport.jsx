...
export function StudyReport(props) {
    const [Studyworktask, setStudyworktask] = useState([])
    ...
    useEffect(() => {
        const GetStudyData = async () => {
            try {
                const response = await axios.post(`${process.env.REACT_APP_BASE_URL}task/studywork`, {
                ...
                setStudyworktask(response.data)
            } catch (error) {
                            ...
                            <Card className="shadow">
                                <CardHeader className="border-0">
                                    <Row className="align-items-center">
                                        <div className="col">
                                            <h3 className="mb-0">Study report</h3>
                                        </div>
                                ...
                                <Table className="align-items-center table-flush" responsive>
                                    ...
                                    <tbody>
                                        {Studyworktask && Studyworktask.map((prop, index) => (
                                            <tr>
                                                <td>
                                                    {index + 1}
                                                </td>
