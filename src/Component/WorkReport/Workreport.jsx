...
export function Workreport(props) {
    const [officeworktask, setofficeworktask] = useState([])
    ...
    useEffect(() => {
        const GetWorkData = async () => {
            try {
                const response = await axios.post(`${process.env.REACT_APP_BASE_URL}task/officeworklist`, {
                ...
                setofficeworktask(response.data)
            } catch (error) {
                            ...
                            <Card className="shadow">
                                <CardHeader className="border-0">
                                    <Row className="align-items-center">
                                        <div className="col">
                                            <h3 className="mb-0">Office Work report</h3>
                                        </div>
                                    </Row>
                                </CardHeader>
                                <Table className="align-items-center table-flush" responsive>
                                    ...
                                    <tbody>
                                        {officeworktask && officeworktask.map((prop, index) => (
                                            <tr>
                                                <td>
                                                    {index + 1}
                                                </td>
