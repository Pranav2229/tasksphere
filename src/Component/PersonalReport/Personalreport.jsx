...
export function Personalreport(props) {
    const [Personalworktask, setPersonalworktask] = useState([])
    ...
    useEffect(() => {
        const GetWorkData = async () => {
            try {
                const response = await axios.post(`${process.env.REACT_APP_BASE_URL}task/personalwork`, {
                ...
                setPersonalworktask(response.data)
            } catch (error) {
                            ...
                            <Card className="shadow">
                                <CardHeader className="border-0">
                                    <Row className="align-items-center">
                                        <div className="col">
                                            <h3 className="mb-0">Personal report</h3>
                                        </div>
                                    </Row>
                                </CardHeader>
                                <Table className="align-items-center table-flush" responsive>
                                    ...
                                    <tbody>
                                        {Personalworktask && Personalworktask.map((prop, index) => (
                                            <tr>
                                                <td>
                                                    {index + 1}
                                                </td>
