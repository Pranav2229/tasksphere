...
export function Upcomeingtask(props) {
    ...
    useEffect(() => {
        const GetUpcomingData = async () => {
            try {
                const response = await axios.post(`${process.env.REACT_APP_BASE_URL}task/upcomingtask`, {
                            ...
                            <Card className="shadow">
                                <CardHeader className="border-0">
                                    <Row className="align-items-center">
                                        <div className="col">
                                            <h3 className="mb-0">Up Comeing List</h3>
                                        </div>
                                        <div className="col text-right">
                                            <Button
                                                color="primary"
                                                onClick={(e) => navigate('/tasklist')} size="sm"
                                            >
                                                See all
                                            </Button>
                                        </div>
                                ...
                                <Table className="align-items-center table-flush" responsive>
                                    ...
                                    <tbody>
                                        {upcomingtask && upcomingtask.slice(0, 5).map((prop, index) => (
                                            <tr>
                                                <td>
                                                    {index + 1}
                                                </td>
